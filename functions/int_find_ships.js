...
exports.int_find_ships = function(start_date, last_date, AOI, min_scale, s1_min_value, s1_max_value, s1_connectedness, s1_radius, s2_min_value, s2_max_value, s2_min_water,s2_k_radius,s2_n_iterations,s2_cloud_coverage){
  ...
  var s2_up_threshold = ee.Number(s2_max_value || 0.1);
  var s1_compactness = ee.Number(s1_connectedness || 10);//try also 1
  var s1_size = ee.Number(s1_radius || 3);//try also 3
  ...
  */
  ...
  var s2_ships = int_find_ships_s2.int_find_ships_s2(s2_series,AOI,s2_up_threshold,s2_low_threshold,s2_water_low_threshold,s2_radius,s2_iterations,scale_to_use);
