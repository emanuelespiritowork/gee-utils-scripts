...
exports.int_find_ships = function(start_date, last_date, AOI, min_scale, min_value, connectedness, radius){
  ...
  var using_img_coll = select_IW_HV_D_H.filterBounds(AOI) || select_IW_VH_D_H.filterBounds(AOI) || select_IW_VH_A_H.filterBounds(AOI) ||  select_IW_HV_A_H.filterBounds(AOI);
