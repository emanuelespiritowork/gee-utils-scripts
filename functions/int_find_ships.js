...
exports.int_find_ships = function(start_date, last_date, AOI, min_scale, min_value, max_value, connectedness, radius){
  //mandatory inputs
  ...
  var low_threshold = min_value || ee.Number(-16);
  var up_threshold = max_value || ee.Number(0);
  ...
  scale_to_use, low_threshold, up_threshold, compactness, size);
};