...
*******************************************************/
  ...
  var global_dsm = ee.ImageCollection("COPERNICUS/DEM/GLO30").select("DEM");
  ...
  var tall_mask = dsm_delta_dtm.lt(20);
...
*******************************************************/
  ...
  Map.addLayer(slope_elev_grass_mask,{},"slope_elev_grass_mask");
